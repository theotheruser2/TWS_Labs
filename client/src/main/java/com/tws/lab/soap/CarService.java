 ...
 * 
 */
@WebServiceClient(name = "CarService", targetNamespace = "http://soap.lab.tws.com/", wsdlLocation = "http://localhost:8081/CarService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/CarService?wsdl");
